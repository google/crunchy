...
#ifndef CRUNCHY_CRUNCHY_CRYPTER_H_
#define CRUNCHY_CRUNCHY_CRYPTER_H_
...
// An API that supports symmetric encryption.
class CrunchyCrypter {
 public:
  virtual ~CrunchyCrypter() = default;
...
#endif  // CRUNCHY_CRUNCHY_CRYPTER_H_
