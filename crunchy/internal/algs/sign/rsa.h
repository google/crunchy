...
enum class PaddingAlgorithm {
  ...
  // ModulusBitLength::B2048 and ModulusBitLength::B4096 RSA signatures.
  PKCS1,
  // RSASSA-PSS signer is based on RFC 3447
  // (https://tools.ietf.org/html/rfc3447) and can be used with both
  // ModulusBitLength::B2048 and ModulusBitLength::B4096 RSA signatures. The
  // salt length used matches the length of the hash algorithm.
  PSS,
};

enum class ModulusBitLength {
  B2048 = 2048,
  B4096 = 4096,
};
