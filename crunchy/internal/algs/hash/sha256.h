...
#ifndef CRUNCHY_ALGS_HASH_SHA256_H_
#define CRUNCHY_ALGS_HASH_SHA256_H_
...
StatusOr<std::string> Sha256Hash(absl::string_view input1, absl::string_view input2);

}  // namespace crunchy

#endif  // CRUNCHY_ALGS_HASH_SHA256_H_
